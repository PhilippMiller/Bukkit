	...
	public boolean doCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (cmd.getName().equals("wispi")) {
			...
			if ((args.length >= 2) && (otherPlayer == null)) {
				sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED + "Der Spieler "
						+ ChatColor.DARK_RED + otherPlayer + ChatColor.RED + " ist nicht online!");
			}
			if (args.length < 2) {
				sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED + "Der richtige Befehl lautet: "
			...
			if (otherPlayer != null) {
				...
				sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.AQUA + "WHISPER an "
						+ ChatColor.DARK_GRAY + args[0] + ": " + text);
				otherPlayer.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.AQUA + "WHISPER von "
						+ ChatColor.DARK_GRAY + sender.getName() + ": " + text);
				return true;
			}
		...
		// ###########################
			...
			if (args.length == 0) {
				...
				if (gm == GameMode.CREATIVE) {
					...
					sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.GREEN + "Du bist nun im "
			...
			if (args.length == 1) {
				...
				if (args[0].equalsIgnoreCase("creative") == true) {
					if (gm == GameMode.CREATIVE) {
						sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED
				...
				if (otherPlayer != null) {
					...
					if (gm_other == GameMode.CREATIVE) {
						...
						sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.DARK_GREEN
				...
				if ((args[0].equalsIgnoreCase("survival") == false)
						&& (args[0].equalsIgnoreCase("creative") == false)) {
					sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED + "Mögliche GameModes: "
			...
			if ((args.length >= 2) && (otherPlayer != null)) {
				...
				if (args[1].equalsIgnoreCase("creative") == true) {
					if (gm == GameMode.CREATIVE) {
						...
						player.setGameMode(GameMode.CREATIVE);
						sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.GREEN + "Der Spieler "
				...
				if ((args[1].equalsIgnoreCase("survival") == false)
						&& (args[1].equalsIgnoreCase("creative") == false)) {
					sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED + "Mögliche GameModes: "
							+ ChatColor.DARK_RED + "Creative , Survival");
					return true;
				}
		...
		// ###########################
			...
			if (args.length == 0) {
				...
				sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED + "Für [time] kann "
						+ ChatColor.DARK_RED + "\"tag\", \"nacht\" oder ein Ganzzahliger Wert " + ChatColor.RED
						+ "eingegeben werden.");
				return true;
			}
			...
			if (args[0].equalsIgnoreCase("tag")) {
				world.setTime(1000);
				sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.GREEN + "Es ist "
			...
			try {
				...
				sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.RED + "Bitte " + ChatColor.DARK_RED
						+ "\"tag\",\"nacht\" oder einen Ganzzahligen Wert eingeben!");
				return true;
			}

			world.setTime(wert);
			sender.sendMessage(ChatColor.GOLD + "[MyEssentials]: " + ChatColor.GREEN + "Die Zeit wurde auf "
		...
		// ##################################
			...
			if (args.length == 0) {
				sender.sendMessage(
						ChatColor.GOLD + "[MyEssentials] " + ChatColor.RED + "Du musst eine ItemID angeben.");
				...
				try {
					...
					sender.sendMessage(
							ChatColor.GOLD + "[MyEssentials] " + ChatColor.RED + "Diese ID kenne ich nicht!");
					return true;
				}
